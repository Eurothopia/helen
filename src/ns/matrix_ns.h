...
//////////////////////////////////////////////////////////////////////////////// 
inline const String SYMBOL_MAP[KEYS_COUNT] = {
  "ON", "OFF","+/-","sqrt","%",
  "7",  "8",  "9",  "x",   "/",
  "4",  "5",  "6",  "-",   "(",
  "1",  "2",  "3",  "+",   ")",
...
inline const String SYMBOL_MAP_ALT[KEYS_COUNT] = {
  "ON", "OFF","+/-","sq(",   "%",
  "7",  "8",  "9",  "LEFT","RIGHT",
  "4",  "5",  "6",  "^",   "√",
  "1",  "2",  "3",  "+",   "M-",
...
//////////////////////////////////////////////////////////////////////////////// 
inline const char* ABC_MAP[KEYS_COUNT] = {
  "a","b","c","d","e",
  "f","g","h","i","j",
  "k","l","m","n","o",
  "p","r","s","t","u",
...
//////////////////////////////////////////////////////////////////////////////// 
inline const char* GSX_MAP[KEYS_COUNT] =  {
  "START","",  "",     "OPT","START",
  "",    "UP",  "",     "",   "",
  "LEFT","DOWN","RIGHT","",   "",
  "",    "",    "",     "A",  "B",
